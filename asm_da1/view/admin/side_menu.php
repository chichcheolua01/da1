<div class="p-[20px] border border-y-0 border-l-0 border-r-[1px] border-gray-300 w-[40%]">
    ...
    <div class="py-[20px] px-[5px]">
        ...
        <a href="./index.php?act=overview">
            <button class="w-full">
                <div class="py-[10px]">
                    <div class="flex items-center text-gray-500 hover:text-white border-0 rounded-2xl hover:bg-[#6C5DD3] px-[12px] duration-300">
    ...
    <div class="py-[20px] px-[5px]">
        <p class="text-sm text-gray-500 font-semibold">Insights</p>
