        ...
        <div class="w-[500px] mx-auto grid place-items-end">
                ...
                <a href="#">
                    <div class="grid grid-cols-4 justify-items-end gap-3 border-b-2 p-1 m-2">
                        <div class="col-span-1">
                            <img src="https://galle.vn/media/catalog/product/cache/4eb977b9e79759bad481a70e526f1a23/r/e/re-av0006y-01_1546484306.png"
                                alt="">
                        </div>
            ...
            <div class="bg-gray-100 w-full">
                ...
                <div class="px-10 py-5">
                    <button
                        class="bg-[#662d91] hover:bg-[#662d99] text-white font-semibold w-full rounded-full py-2 my-1">Mua
                        ngay</button>
