                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <div>
                                    <form action="../../controller/add_to_cart.php?" method="POST">
                                        ...
                                        <input type="text" class="hidden" name="categoryImage" F value="<?php echo $item_category["categoryImage"] ?>">
                                        ...
                                        <button type="submit" class="bg-purple-800 text-white mt-2 p-2 px-3 w-52 left-12 rounded-3xl transform group-hover:bottom-0 group-hover:left-12 duration-500 absolute -bottom-16">
                                            THÊM
                                            VÀO GIỎ HÀNG</button>
                                </div>
                                </form>
