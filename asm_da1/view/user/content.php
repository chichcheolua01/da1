                ...
                <a
                    ...
                    <div class="overflow-hidden relative flex flex-col justify-between">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <a href=""
                                class="bg-purple-800 text-white mt-2 p-2 px-3 w-52 left-12 rounded-3xl transform group-hover:bottom-0 group-hover:left-12 duration-500 absolute -bottom-16">THÊM
                                VÀO GIỎ HÀNG</a>
                        </div>
                    </div>
                </a>
