        ...
        <div class="col-span-2 border shadow-[0px_0px_5px_1px_rgba(0,0,0,0.2)] mt-8 p-5">
            <form action="./index.php?act=payment" method="POST" onsubmit="return validate()" enctype="multipart/form-data">
                <div class="mt-5">
                    ...
                    <div>
                        <input type="text" required name="email" class="email border border-gray-300 px-14 py-1 rounded-2xl my-2 outline-none" value="<?php echo $user['userEmail'] ?>" >
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-y-4 border-b-2 pb-3">
                    <div>
                        ...
                        <input type="text" required name="userName" class="username border border-gray-300 px-14 py-1 rounded-2xl  my-2 outline-none" value="<?php echo $user['userFullname'] ?>">
                    </div>
                    <div>
                        <label for="address"><span class="font-sans">Địa chỉ đường</span></label>
                        <div>
                            <input type="text" required name="address" class="address border border-gray-300 px-14 py-1 rounded-2xl  my-2 outline-none">
                        </div>
                    </div>
                    <div>
                        <label for="phoneNumber"><span class="font-sans">Số điện thoại</span></label>
                        <div>
                            <input type="text" required name="phoneNumber" class="phoneNumber border border-gray-300 px-14 py-1 rounded-2xl  my-2 outline-none">
                        </div>
                    </div>
                    <div>
                        <label for="province"><span class="font-sans">Tỉnh/Thành phố</span></label>
                        <div>
                            <input type="text" required name="province" class="province border border-gray-300 px-14 py-1 rounded-2xl  my-2 outline-none">
                        </div>
                    </div>
                    <div>
                        <label for="district"><span class="font-sans">Quận/huyện</span></label>
                        <div>
                            <input type="text" required name="district" class="district border border-gray-300 px-14 py-1 rounded-2xl  my-2 outline-none">
                        </div>
                    </div>
                    <div>
                        <label for="commune"><span class="font-sans">Phường/xã</span></label>
                        <div>
                            <input type="text" required name="commune" class="commune border border-gray-300 px-14 py-1 rounded-2xl  my-2 outline-none">
                        </div>
                    </div>
                </div>
                <!-- 2 row end -->
                ...
                <div class="space-x-5">
                    ...
                    <input class="px-5 my-3 py-1 border rounded-3xl text-gray-500 hover:shadow-[0px_0px_5px_1px_rgba(0,0,0,0.56)] focus:bg-purple-800 focus:text-white" value="Giao hàng tận nơi" type="button" onclick="choose_delivery_place(this)"></input>
                </div>
                <!--  -->
                ...
                <div>
                    ...
                    <textarea name="note" class="border border-gray-300 rounded-3xl p-2 mt-2" cols="80" rows="4"></textarea>
                </div>
                <!-- dow 2 end -->
        ...
        <div class="relative shadow-[0px_0px_5px_1px_rgba(0,0,0,0.2)] mt-8 p-5 ">
            <div class="grid grid-rows-3">
                ...
                if (isset($_SESSION['mycart'])) {
                    ...
                    echo "<p>Không có sản phẩm nào trong giỏ hàng! <a class='underline' href='index.php?act=home'>Quay lại trang chủ</a></p>";
                } ?>
                ...
                <div class="">
                    ...
                    if (isset($_SESSION['mycart'])) {
                        echo "<button name='submit' class='bg-purple-800 text-white py-1 px-8 rounded-3xl my-4'>ĐẶT HÀNG</button>";
                    } else {
                        echo "<button name='submit' class='bg-purple-800 text-white py-1 px-8 rounded-3xl my-4' disabled>ĐẶT HÀNG</button>";
                    }
